CLASS zrap100_cl_eml_fie DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZRAP100_CL_EML_FIE IMPLEMENTATION.
...
*        FIELDS ( AgencyID CustomerID BeginDate Description )
  ...
  METHOD update_travel.
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_fie
      ENTITY Travel
    ...
    COMMIT ENTITIES
      RESPONSE OF ZRAP100_R_TravelTP_fie
