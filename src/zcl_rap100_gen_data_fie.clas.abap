CLASS zcl_rap100_gen_data_fie DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_FIE IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'fie',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravfie.
*    DELETE FROM zrap100_dtravfie.
    out->write( sy-subrc && ' Delete' ).

    "insert travel demo data
    INSERT zrap100_atravfie  FROM (
        SELECT
