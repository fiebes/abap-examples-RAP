class ZRAP110_EML_PLAYGROUND_001 definition
  public
  final
  create public .
...
CLASS ZRAP110_EML_PLAYGROUND_001 IMPLEMENTATION.


METHOD IF_OO_ADT_CLASSRUN~MAIN.
     "declare internal table using derived type
     DATA travel_keys TYPE TABLE FOR READ IMPORT ZRAP110_R_TravelTP_001 .

     "fill in relevant travel keys for READ request
     travel_keys = VALUE #( ( TravelID = '4148' )
                           "( TravelID = '...' )
                          ).

     "insert your coding here
     "read _travel_ instances for specified key
     READ ENTITIES OF ZRAP110_R_TravelTP_001
       ENTITY Travel
*        ALL FIELDS
