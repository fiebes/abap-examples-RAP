CLASS zrap620_cl_ce_products_fie DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_product_range TYPE RANGE OF zrap620_sc_products_fie=>tys_sepmra_i_product_etype.
    TYPES t_business_data TYPE zrap620_sc_products_fie=>tyt_sepmra_i_product_etype.
    TYPES t_business_data_external TYPE TABLE OF zrap620_ce_products_fie.
...
CLASS zrap620_cl_ce_products_fie IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        ...
        DATA(request) = VALUE zrap620_af3req_msg_type(  req_msg_type-product = 'HT-1011' ).
        proxy->get_price(
          EXPORTING
            input = request
          IMPORTING
      ...
      CATCH cx_ai_system_fault.
        "handle error
      CATCH zrap620_af3cx_fault_msg_type.
        "handle error
    ENDTRY.
    ...
    odata_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
      EXPORTING
         is_proxy_model_key       = VALUE #( repository_id       = 'DEFAULT'
                                             proxy_model_id      = 'ZRAP620_SC_PRODUCTS_FIE'
