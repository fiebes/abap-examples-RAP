...
define view entity ZRAP110_R_BOOKINGTP_001
  as select from ZRAP110_ABOOK001 as Booking
  association to parent ZRAP110_R_TRAVELTP_001 as _Travel on $projection.TravelID = _Travel.TravelID
